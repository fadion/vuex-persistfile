...
var _FsDriver = __webpack_require__(3);

var _FsDriver2 = _interopRequireDefault(_FsDriver);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var VuexPersist = function () {
  /**
   * Constructor.
   * @param {object} options
   */
  function VuexPersist(options) {
    _classCallCheck(this, VuexPersist);
    ...
    this.driver = options.driver || new _FsDriver2.default();
    this.options.path = _path2.default.join(this.options.path, this.options.file);
  }
  ...
  _createClass(VuexPersist, [{
    ...
    value: function loadState(store) {
      try {
        var data = this.driver.read(this.options.path);
        store.replaceState((0, _deepmerge2.default)(store.state, JSON.parse(data)));
      } catch (err) {}
    }
    ...
    value: function subscribe() {
      ...
      return function (store) {
        _this.loadState(store);

        store.subscribe(function (mutation, state) {
          if (_this._mutation(mutation.type)) {
...
var FsDriver = function () {
  ...
  _createClass(FsDriver, [{
    ...
    value: function write(path, data) {
      _fs2.default.writeFileSync(path, data, 'utf8');
    }
  }, {
    key: 'read',
